...
(function() {
    ...
    function J(a, b, c) {
        var d, e;
        if (Da(b)) q(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));
        else if (q(b) && da(b))
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = [];
            ...
            if (d) {
                ...
                if (f.length) f = f.join(":"), g = /\.([0-9])/, h = T.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = z.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Oa(f, e)
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    var y, B = document,
        ...
        Ib = K.opera,
        ya = /(msie|trident)/i.test(Ba) && !Ib,
        hb = B.documentMode === 8,
        ib = /AppleWebKit/.test(Ba),
        La = /Firefox/.test(Ba),
        Jb = /(Mobile|Android|Windows Phone)/.test(Ba),
        Ca = "http://www.w3.org/2000/svg",
        ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect,
        Nb = La && parseInt(Ba.split("Firefox/")[1], 10) < 4,
        fa = !ca && !ya && !!B.createElement("canvas").getContext,
        $a, ab, Kb = {},
        yb = 0,
        fb, T, Oa, za, zb, D, na = function() {
            return y
        },
        Y = [],
        bb = 0,
        ...
        O = "none",
        Ob = /^[0-9]+$/,
        jb = ["plotTop", "marginRight", "marginBottom", "plotLeft"],
        Pb = "stroke-width",
        Aa, gb, ob, eb, sb, tb, ub, Xa, Ya, Za, Db, Eb, Fb, Gb, vb, wb, xb, M = {},
        z;
    z = K.Highcharts = K.Highcharts ? la(16, !0) : {};
    z.seriesTypes = M;
    var x = z.extend = function(a,
            b) {
            var c;
            a || (a = {});
            for (c in b) a[c] = b[c];
    ...
    z.numberFormat = function(a, b,
        c, d) {
        var e = T.lang,
            a = +a || 0,
            f = b === -1 ? C((a.toString().split(".")[1] || "").length, 20) : isNaN(b = N(b)) ? 2 : b,
    ...
    zb = {
        ...
        step: function(a, b, c, d) {
            ...
            if (c === 1) e = d;
                ...
                for (; f--;) d = parseFloat(a[f]), e[f] = isNaN(d) ? a[f] :
            ...
            init: function(b) {
                ...
                a.fn.highcharts = function() {
                    ...
                    if (this[0]) {
                        ...
                        c = b[0];
                        if (c !== y) c.chart = c.chart || {}, c.chart.renderTo = this[0], new z[a](c, b[1]), g = this;
    ...
    P.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && m && !q(g.gradientUnits) && (g = A(g, {
                    cx: m[0] - m[2] /
                        2 + g.cx * m[2],
                ...
                for (n in g) n !== "id" && u.push(n, g[n]);
                for (n in j) u.push(j[n]);
                u = u.join(",");
                h[u] ? a = h[u].attr("id") : (g.id = a = "highcharts-" + yb++, h[u] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], o(j, function(a) {
        ...
        applyTextShadow: function(a) {
            var b = this.element,
                ...
                e = {},
                f = this.renderer.forExport || b.style.textShadow !== y && !ya;
        ...
        updateShadows: function(a, b) {
            for (var c = this.shadows, d = c.length; d--;) c[d].setAttribute(a, a === "height" ? v(b - (c[d].cutHeight ||
                0), 0) : a === "d" ? this.d : b)
        },
        addClass: function(a) {
            var b = this.element,
        ...
        css: function(a) {
            ...
            if (e) {
                ...
                b && (a = x(b, c));
                this.styles = a;
                e && (fa || !ca && this.renderer.forExport) &&
                    delete a.width;
        ...
        getBBox: function(a) {
            ...
            d !== y && (l = ["", e || 0, g && g.fontSize, f.style.width].join(","),
                l = d === "" || Ob.test(d) ? "num:" + d.toString().length + l : d + l);
            l && !a && (b = c.cache[l]);
            if (!b) {
                if (f.namespaceURI === Ca || c.forExport) {
                    try {
                        ...
                        }, La && j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(O), b = f.getBBox ? x({}, f.getBBox()) : {
                            width: f.offsetWidth,
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) J(f, "height", v(J(f, "height") - h, 0)), f.cutHeight = h;
        ...
        zIndexSetter: function(a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i < d.length && !h; i++)
                    if (e =
                        d[i], f = J(e, "zIndex"), e !== g && (F(f) > a || !q(a) && q(f))) c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    P.prototype["stroke-widthSetter"] = P.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        if (this.stroke &&
            this["stroke-width"]) this.strokeWidth = this["stroke-width"], P.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    ua.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.createElement("desc").add().element.appendChild(B.createTextNode("Created with Highcharts 4.1.6"));
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = J(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k && k.textShadow, u = k && k.textOverflow === "ellipsis", r = g.length, S = l && !a.added && this.box, Q = function(a) {
                    return m ? F(m) : c.fontMetrics(/(px|em)$/.test(a &&
                        a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
                }, t = function(a) {
                    return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                }; r--;) b.removeChild(g[r]);
            !f && !n && !u && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), o(e, function(e, f) {
                var g, m = 0,
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        var n = {},
                            r = B.createElementNS(Ca, "tspan"),
                            p;
                        h.test(e) && (p = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), J(r, "style", p));
                        i.test(e) && !d && (J(r, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(r, {
                            cursor: "pointer"
                        }));
                        e = t(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 && k.whiteSpace !== "nowrap", S, w, q, v = [], y = Q(r), s = 1, x = a.rotation, A = e, C = A.length;
                                    (o || u) && (n.length || v.length);) a.rotation = 0, S = a.getBBox(!0), q = S.width, !ca && c.forExport && (q = c.measureSpanWidth(r.firstChild.data, a.styles)), S = q > l, w === void 0 && (w = S), u && w ? (C /= 2, A === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), A = e.substring(0, A.length + (S ? -1 :
                                    1) * ta(C)), n = [A + (l > 3 ? "…" : "")], r.removeChild(r.firstChild))) : !S || n.length === 1 ? (n = v, v = [], n.length && (s++, r = B.createElementNS(Ca, "tspan"), J(r, {
                                    dy: y,
                                    x: j
                                }), p && J(r, "style", p), b.appendChild(r)), q > l && (l = q)) : (r.removeChild(r.firstChild), v.unshift(n.pop())), n.length && r.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            H(j.element, ya ? "mouseout" : "mouseleave", function() {
                k !== 3 && (l = [e, f, g][k], m = [n, u, r][k], j.attr(l).css(m))
            });
            j.setState = function(a) {
                (j.state = k = a) ? a === 2 ? j.attr(g).css(r) : a === 3 && j.attr(h).css(p): j.attr(e).css(n)
            };
        ...
        symbols: {
            ...
            callout: function(a,
                ...
                h && h > c && e > b + g && e < b + d - g ? i.splice(13, 3, "L", a + c, e - 6, a + c + 6, e, a + c, e + 6, a + c, b + d - f) : h && h < 0 && e > b + g && e < b + d - g ? i.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + f) : e && e > d && h > a + g && h < a + c - g ? i.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d) : e && e < 0 && h > a + g && h < a + c - g && i.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6,
                    b, c - f, b);
                return i
            }
        },
        ...
        fontMetrics: function(a, b) {
            ...
            if (b && K.getComputedStyle) b = b.element || b, a = K.getComputedStyle(b, "").fontSize;
            var a = /px/.test(a) ? F(a) : /em/.test(a) ? parseFloat(a) * 12 : 12,
                c = a < 24 ? a + 3 : s(a * 1.2),
                d = s(c * 0.8);
            return {
                h: c,
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                var a,
                    b;
                a = u.element.style;
                p = (ga === void 0 || v === void 0 || n.styles.textAlign) && q(u.textStr) && u.getBBox();
                n.width = (ga || p.width || 0) + 2 * t + w;
                n.height = (v || p.height || 0) + 2 * t;
                F = t + m.fontMetrics(a && a.fontSize, u).b;
                if (E) {
                    if (!r) a = s(-Q * t) + z, b = (h ? -F : 0) + z, n.box = r = d ? m.symbol(d, a, b, n.width, n.height, G) : m.rect(a, b, n.width, n.height, 0, G[Pb]), r.attr("fill", O).add(n);
                    r.isImg || r.attr(x({
                        width: s(n.width),
                        height: s(n.height)
                    }, G));
            ...
            function k() {
                var a = n.styles,
                    ...
                    c;
                c = h ? 0 : F;
                if (q(ga) && p && (a === "center" || a ===
                        "right")) b += {
                    center: 0.5,
                    right: 1
                }[a] * (ga - p.width);
                if (b !== u.x || c !== u.y) u.attr("x", b), c !== y && u.attr("y", c);
                u.x = b;
                u.y = c
            }
    ...
    x(P.prototype, {
        htmlCss: function(a) {
            var b = this.element;
            if (b =
                a && b.tagName === "SPAN" && a.width) delete a.width, this.textWidth = b, this.updateTransform();
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    var k = this.rotation,
                        l, m = F(this.textWidth),
                        n = [k, g, b.innerHTML, this.textWidth].join(",");
                    if (n !== this.cTT) {
                        l = a.fontMetrics(b.style.fontSize).b;
                        q(k) && this.setSpanRotation(k, h, l);
                        i = p(this.elemWidth, b.offsetWidth);
                        if (i >
                            m && /[ \-]/.test(b.textContent || b.innerText)) L(b, {
                            width: m + "px",
                            display: "block",
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = ya ? "-ms-transform" : ib ? "-webkit-transform" : La ? "MozTransform" : Ib ? "-o-transform" : "";
    ...
    if (!ca && !fa) {
        E = {
            ...
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--;)
                    if (ra(a[b])) c[b] = s(a[b] * 10) - 5;
                    else if (a[b] === "Z") c[b] = "x";
                else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ?
                    1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
                return c.join(" ") || "x"
            },
            clip: function(a) {
                var b = this,
            ...
            shadow: function(a, b, c) {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        j = ['<shape isShadow="true" strokeweight="', l, '" filled="false" path="', m, '" coordsize="10 10" style="',
                            f.style.cssText, '" />'
                        ];
                        h = $(g.prepVML(j), null, {
        ...
        var Na = {
            ...
            init: function(a, b, c, d) {
                var e;
                this.alignedObjects = [];
                d = this.createElement(Ka).css(x(this.getStyle(d), {
                    position: "relative"
                }));
                e = d.element;
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient,
                        ...
                        w, ga = [],
                        q = function() {
                            h = ['<fill colors="' + ga.join(",") + '" opacity="', r, '" o:opacity2="', u, '" type="', i, '" ', t, 'focus="100%" method="any" />'];
                    ...
                    o(a, function(a, b) {
                        g.test(a[1]) ?
                            (f = oa(a[1]), k = f.get("rgb"), l = f.get("a")) : (k = a[1], l = 1);
                        ga.push(a[0] * 100 + "% " + k);
                        b ? (r = l, p = k) : (u = l, Q = k)
                    });
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"', q();
                        else {
                            var j = m.r,
                                v = j * 2,
                                y = j * 2,
                                ...
                                C = b.radialReference,
                                A, j = function() {
                                    C && (A = d.getBBox(), s += (C[0] - A.x) / A.width - 0.5, x += (C[1] - A.y) / A.height - 0.5, v *= C[2] / A.width, y *= C[2] / A.height);
                                    t = 'src="' + T.global.VMLRadialGradientURL + '" size="' + v + "," + y + '" origin="0.5,0.5" position="' +
                                        s + "," + x + '" color2="' + Q + '" ';
                                    q()
                                };
                            d.added ? j() : d.onAdd = j;
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = oa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
        ...
        z.VMLRenderer = E = function() {
            this.init.apply(this,
                arguments)
        };
        E.prototype = A(ua.prototype, Na);
        $a = E
    }
    ...
    var Lb;
    if (fa) z.CanVGRenderer = E = function() {
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            q(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(A(g.style)).add(a.labelGroup) :
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                l = 1,
                m;
            if (h) h < 0 && c - i * j < f ? m = s(c / X(h * ha) - f) : h > 0 && c + i * j > e && (m = s((d - c) / X(h * ha)));
            else if (d = c + (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) -
                f : d > e && (k = e - a.x + k * i, l = -1), k = C(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" && (a.x += l * (b.slotWidth - k - i * (b.slotWidth - C(j, k)))), j > k || b.autoRotation && g.styles.width) m = k;
            m && g.css({
                width: m,
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                q = !0,
                v = d.tickmarkOffset,
                s = this.getPosition(g, j, v, b),
                x = s.x,
                s = s.y,
                A = g && x === d.pos + d.len || !g && s === d.pos ? -1 : 1,
                c = p(c, 1);
            this.isActive = !0;
            if (u) {
                j = d.getPlotLinePath(j + v, u * A, b, !0);
                if (l === y) {
                    l = {
                        stroke: r,
                        "stroke-width": u
            ...
            if (m && Q) w === "inside" && (Q = -Q), d.opposite && (Q = -Q), h = this.getMarkPath(x, s, Q, m * A, g, f), n ? n.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(x)) i.xy = s = this.getLabelPosition(x, s, i, g, k, v, a, ga), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 : g && !d.isRadial && !k.step &&
                !k.rotation && !b && c !== 0 && this.handleOverflow(s), ga && a % ga && (q = !1), q && !isNaN(s.y) ? (s.opacity = c, i[this.isNew ? "attr" : "animate"](s), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Qa(this, this.axis)
        }
    ...
    z.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (m)
                ...
                } else if (n && n.length && (a.svgElem = m = w.path(n).attr(t).add(), o))
    ...
    va.prototype = {
        ...
        init: function(a, b) {
            ...
            Ma(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
        ...
        setOptions: function(a) {
            this.options = A(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], A(T[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === y;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = z.numberFormat(b / c, -1) + e[f]);
            g === y && (g = N(b) >= 1E4 ? z.numberFormat(b, 0) : z.numberFormat(b, -1, y, ""));
            return g
        },
        getSeriesExtremes: function() {
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = C(p(a.dataMin, d[0]), Pa(d)), a.dataMax = v(p(a.dataMax, d[0]), Fa(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (q(c) && q(e)) a.dataMin = C(p(a.dataMin, c), c), a.dataMax = v(p(a.dataMax, e), e);
                        if (q(d))
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            var n = function(a, b, c) {
                    if (a < b || a > c) d ? a = C(v(b, a), c) : m = !0;
                    return a
                },
                e = p(e, this.translate(a, null, null, c)),
                a = c = s(e + i);
            i = j = s(k - e - i);
            isNaN(e) ? m = !0 : this.horiz ? (i = h, j = k - this.bottom, a = c = n(a, g, g + this.width)) : (a = g, c = l - this.right, i = j = n(i,
                h, h + this.height));
        ...
        setAxisTranslation: function(a) {
            var b = this,
                ...
                k = b.isXAxis;
            if (k || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) :
                    o(b.series, function(a) {
                        var h = i ? 1 : k ? a.pointRange : b.axisPointRange || 0,
                            j = a.options.pointPlacement,
                            u = a.closestPointRange;
                        h > c && (h = 0);
                        d = v(d, h);
                        b.single || (f = v(f, Da(j) ? 0 : h / 2), g = v(g, j === "on" ? 0 : h));
                        !a.noSharedTooltip && q(u) && (e = q(e) ? C(e, u) : u)
        ...
        setTickInterval: function(a) {
            ...
            if (e) !a && C(b.min, p(b.dataMin, b.min)) <= 0 && la(10, 1), b.min = ea(Ea(b.min)),
                b.max = ea(Ea(b.max));
            if (b.range && q(b.max)) b.userMin = b.min = v(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
            ...
            if (ra(d.ceiling)) b.max = C(b.max, d.ceiling);
            b.tickInterval =
                b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 : h && !k && l === b.linkedParent.options.tickPixelInterval ? k = b.linkedParent.tickInterval : p(k, this.tickAmount ? (b.max - b.min) / v(this.tickAmount - 1, 1) : void 0, m ? 1 : (b.max - b.min) * l / v(b.len, l));
        ...
        zoom: function(a, b) {
            var c = this.dataMin,
                d = this.dataMax,
                e = this.options;
            this.allowZoomOutside || (q(c) && a <= C(c, p(e.min, c)) && (a = y), q(d) && b >= v(d, p(e.max, d)) && (b = y));
        ...
        unsquish: function() {
            ...
            c ? (l = q(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) && o(l, function(a) {
                var b;
                if (a === h || a && a >= -90 && a <= 90) j = m(N(i.h / aa(ha * a))), b = j + N(a / 360), b < k && (k = b, g = a, e = j)
            }) : e = m(i.h);
            this.autoRotation = l;
        ...
        renderUnsquish: function() {
            ...
            o(c, function(a) {
                var b = (a = d[a]) && a.label;
                if (b) k && b.css(A(k, b.specCss)), delete b.specCss, b.attr(j), a.rotation = j.rotation
            });
        ...
        getOffset: function() {
            var a = this,
                ...
                t = [-1, 1, 1, -1][h],
                w;
            a.hasData = j = a.hasVisibleSeries || q(a.min) && q(a.max) && !!e;
            ...
            if (j || a.isLinked) {
                if (o(e, function(b) {
                        ...
                        if (h === 0 || h === 2 || {
                                1: "left",
                                3: "right"
                            }[h] === a.labelAlign) S = v(f[b].getLabelSize(), S)
                    }), a.staggerLines) S *= a.staggerLines, a.labelOffset = S
            } else
                for (w in f) f[w].destroy(),
                    delete f[w];
            if (u && u.text && u.enabled !== !1) {
                ...
                if (k) l = a.axisTitle.getBBox()[g ? "height" : "width"], m = u.offset, n = q(m) ? 0 : p(u.margin, g ? 5 : 10);
                a.axisTitle[k ? "show" : "hide"]()
            }
            a.offset = t * p(d.offset, Q[h]);
            a.tickRotCorr = a.tickRotCorr || {
                x: 0,
                y: 0
            };
            c = h === 2 ? a.tickRotCorr.y : 0;
            g = S + n + (S && t * (g ? p(r.y, a.tickRotCorr.y + 8) : r.x) - c);
            a.axisTitleMargin = p(m, g);
            Q[h] = v(Q[h], a.axisTitleMargin + l + t * a.offset, g);
            ...
            if (r || f) {
                ...
                if (g.length && (o(g, function(b, c) {
                        if (!f || b >= a.min && b <= a.max) i[b] ||
                            (i[b] = new Ta(a, b)), p && i[b].isNew && i[b].render(c, !0, 0.1), i[b].render(c)
                    }), n && (a.min === 0 || a.single))) i[-1] || (i[-1] = new Ta(a, -1, null, !0)), i[-1].render(-1);
                m && o(g, function(b, c) {
                    if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new z.PlotLineOrBand(a)), t = b + n, w = g[c + 1] !== y ? g[c + 1] + n : a.max, k[b].options = {
                        from: e ? ia(t) : t,
                        to: e ? ia(w) : w,
                        color: m
    ...
    va.prototype.getTimeTicks = function(a, b, c, d) {
        var e = [],
            ...
            k = a.count;
        if (q(b)) {
            i[Db](j >= D.second ? 0 : k * V(i.getMilliseconds() / k));
            if (j >= D.second) i[Eb](j >= D.minute ? 0 : k * V(i.getSeconds() / k));
            if (j >= D.minute) i[Fb](j >= D.hour ? 0 : k * V(i[sb]() / k));
            if (j >= D.hour) i[Gb](j >= D.day ? 0 : k * V(i[tb]() / k));
            if (j >= D.day) i[vb](j >= D.month ? 1 : k * V(i[Xa]() / k));
            j >= D.month && (i[wb](j >= D.year ? 0 : k * V(i[Ya]() / k)), h = i[Za]());
            j >= D.year && (h -= h % k, i[xb](h));
            if (j === D.week) i[vb](i[Xa]() - i[ub]() + p(d, 1));
            b = 1;
            if (ob || eb) i = i.getTime(), i = new Aa(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), l = i[Ya](), m = i[Xa](), n = (D.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % D.day; d < c;) e.push(d), j === D.year ? d = gb(h + b * k, 0) : j === D.month ? d = gb(h, l + b * k) : !g && (j === D.day || j === D.week) ? d = gb(h, l, m + b * k * (j === D.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            o(lb(e, function(a) {
                return j <=
                    D.hour && a % D.day === n
    ...
    va.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        e === D.year &&
            a < 5 * e && (f = [1, 2, 5]);
        c = qb(a / e, f, d[0] === "year" ? v(pb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    va.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = s(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = V(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) j = Ea(ia(f) * e[h]), j > b && (!d || k <= c) && k !== y && g.push(k), k > c && (l = !0), k = j
            } else if (b = ia(b),
                c = ia(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = qb(a, null, pb(a)), g = Ua(this.getLinearTickPositions(a, b, c), Ea), !d) this._minorAutoInterval = a / 5;
    ...
    Mb.prototype = {
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                u = function() {
                    l.apply(0, i) !== !1 ? m.apply(0, j) === !1 && !h && (n(!0),
                        u()) : h ? f.x = f.y = 0 : (n(!0), u())
                };
        ...
        refresh: function(a, b) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (db(d), d.attr("opacity", 1).show()), d.attr({
                    text: j
        ...
        updatePosition: function(a) {
            ...
            this.move(s(c.x), s(c.y || 0), a.plotX + b.plotLeft, a.plotY + b.plotTop)
        },
        getXDateFormat: function(a, b, c) {
            ...
            if (e) {
                ...
                for (f in D) {
                    if (e === D.week && +Oa("%w", a.x) === c.options.startOfWeek && h.substr(6) === "00:00:00.000") {
                        f = "week";
                        break
                    } else if (D[f] > e) {
                        f = i;
    ...
    Va.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (z.Tooltip && b.tooltip.enabled) a.tooltip = new Mb(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
            this.setDOMEvents()
        },
        normalize: function(a, b) {
            ...
            d.pageX === y ? (c = v(a.x, a.clientX - b.left), d = a.y) : (c = d.pageX - b.left, d = d.pageY - b.top);
            return x(a, {
                chartX: s(c),
                chartY: s(d)
            })
        ...
        drag: function(a) {
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !u && !this.selectionMarker) this.selectionMarker =
    ...
    x(z.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a,
            ...
            var i = this.chart,
                ...
                y = !w && c[1][l],
                x, c = function() {
                    !w && N(q - s) > 20 && (p = h || N(v - y) / N(q - s));
                    r = (n - v) / p + q;
                    u = i["plot" + (a ? "Width" : "Height")] / p
                };
            c();
            b = r;
            b < t.min ? (b = t.min, x = !0) : b + u > t.max && (b = t.max - u, x = !0);
            x ? (v -= 0.8 * (v - g[j][0]), w || (y -= 0.8 * (y - g[j][1])), c()) : g[j] = [v, y];
            o || (f[j] = r - n, f[m] = u);
            f = o ? 1 / p : p;
            e[m] = u;
            e[j] = b;
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        ...
        x(Va.prototype, {
            ...
            batchMSEvents: function(a) {
                ...
                a(this.chart.container, Ab ? "pointermove" :
                    "MSPointerMove", this.onContainerPointerMove);
                a(B, Ab ? "pointerup" : "MSPointerUp", this.onDocumentPointerUp)
            }
        });
    ...
    nb.prototype = {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (j in i.stroke = h, g = a.convertAttribs(g), g) d = g[j], d !== y && (i[j] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            ...
            if (e && this.itemX - r + f > (m || b.chartWidth - 2 * j - r - d.x)) this.itemX = r, this.itemY += u + this.lastLineHeight + n, this.lastLineHeight = 0;
            this.maxItemWidth = v(this.maxItemWidth, f);
            this.lastItemY = u + this.itemY + n;
            this.lastLineHeight = v(g, this.lastLineHeight);
            a._legendItemPos = [this.itemX, this.itemY];
            e ? this.itemX += f : (this.itemY += u + g + n, this.lastLineHeight = g);
            this.offsetWidth = m || v((e ? this.itemX - r - k : f) + j, this.offsetWidth)
        },
        ...
        adjustMargins: function(a, b) {
            ...
            this.display && !d.floating && o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) {
                f.test(e) && !q(a[g]) && (c[jb[g]] = v(c[jb[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g]))
            })
        },
        render: function() {
            var a = this,
            ...
            if (a > f && !e.useHTML) {
                ...
                o(r, function(a, b) {
                    var c = a._legendItemPos[1],
                        ...
                        e = n.length;
                    if (!e || c - n[e - 1] > h && (u || c) !== n[e - 1]) n.push(u || c), e++;
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== y && Sa(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    Na = z.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            var e = this.chart.renderer,
                f = this.legendGroup,
                a = a.baseline - s(a.fontMetrics.b * 0.3),
                g;
            if (b.lineWidth) {
                g = {
    ...
    (/Trident\/7\.0/.test(Ba) ||
        La) && cb(nb.prototype, "positionItem", function(a, b) {
        var c = this,
            d = function() {
    ...
    E.prototype = {
        ...
        reflow: function(a) {
            var b = this,
                c = b.options.chart,
                d = b.renderTo,
                e = c.width || kb(d, "width"),
                f = c.height || kb(d, "height"),
                c = a ? a.target : K,
                d = function() {
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a)) d.chartWidth = e = v(0, s(a)), d.hasUserSize = !!e;
            if (q(b)) d.chartHeight = f = v(0, s(b));
            (za ? mb : L)(d.container, {
                width: e + "px",
                height: f +
                    "px"
        ...
        setChartSize: function(a) {
            ...
            this.plotWidth = k = v(0, s(d - i - this.marginRight));
            this.plotHeight = l = v(0, s(e - j - this.marginBottom));
            ...
            this.clipBox = {
                ...
                height: v(0, V(this.plotSizeY - v(d, h[2]) /
                    2 - c))
            };
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(t) : this.plotBackground = b.rect(p, o, q, v, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow);
            if (l) h ? h.animate(t) :
                this.plotBGImage = b.image(l, p, o, q, v).add();
            w ? w.animate({
                width: s.width,
                height: s.height
            ...
            if (m) g ? g.animate(g.crisp({
                ...
                height: v,
                strokeWidth: -m
            })) : this.plotBorder = b.rect(p, o, q, v, 0, -m).attr({
        ...
        isReadyToRender: function() {
            var a = this;
            return !ca && K == K.top && B.readyState !== "complete" || fa && !K.canvg ? (fa ? Lb.push(function() {
                a.firstRender()
    ...
    R.prototype = {
        ...
        setOptions: function(a) {
            ...
            this.userOptions = a;
            c = A(e, c.series, a);
            this.tooltipOptions = A(T.tooltip, T.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip, d[this.type] && d[this.type].tooltip, a.tooltip);
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) o(a, function(a, b) {
                ...
                if (n && h > n) {
                    ...
                    if (ra(k)) {
                        ...
                        for (c = 0; c < h; c++) u[c] = m, r[c] = a[c], m += i;
                        e.xIncrement = m
                    } else if (Ha(k))
                        if (q)
                            for (c = 0; c < h; c++) i = a[c], u[c] = i[0], r[c] = i.slice(1, q + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], u[c] = i[0], r[c] = i[1];
                    else la(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== y && (i = {
                                series: e
                            }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i,
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!i ||
                ...
                else if (b[0] < l || b[d - 1] > m) e = this.cropData(this.xData, this.yData, l, m), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++) i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(sa(e[m]))) : (b[i] ? k = b[i] : a[i] !== y && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k), l[m].index =
                i;
            if (b && (g !== (c = b.length) || j))
                for (m = 0; m < c; m++)
                    if (m === h && !j && (m += g), b[m]) b[m].destroyElements(), b[m].plotX = y;
            this.data = b;
            this.points = l
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h,
                    i && j)
                    if (i = k.length)
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ra(i), k = a.threshold, l = a.startFromThreshold ? k : 0, m, n, u, o = Number.MAX_VALUE, a = 0; a < g; a++) {
                var s = f[a],
                    x = s.x,
                    t = s.y;
                n = s.low;
                var w = b && e.stacks[(this.negStacks &&
                    t < (l ? 0 : k) ? "-" : "") + this.stackKey];
                if (e.isLog && t !== null && t <= 0) s.y = t = null, la(10);
                s.plotX = m = C(v(-1E5, c.translate(x, 0, 0, 0, 1, i, this.type === "flags")), 1E5);
                if (b && this.visible && w && w[x]) w = w[x], t = w.points[this.index + "," + a], n = t[0], t = t[1], n === l && (n = p(k, e.min)), e.isLog && n <= 0 && (n = null), s.total = s.stackTotal = w.total, s.percentage = w.total && s.y / w.total * 100, s.stackY = t, w.setOffset(this.pointXOffset || 0, this.barW || 0);
                s.yBottom = q(n) ? e.translate(n, 0, 1, 0, 1) : null;
                h && (t = this.modifyValue(t, s));
                s.plotY = n = typeof t === "number" && t !==
                    Infinity ? C(v(-1E5, e.translate(t, 0, 1, 0, 1)), 1E5) : y;
                s.isInside = n !== y && n >= 0 && n <= e.len && m >= 0 && m <= c.len;
                s.clientX = j ? c.translate(x, 0, 0, 0, 1) : m;
                s.negative = s.y < (k || 0);
                s.category = d && d[s.x] !== y ? d[s.x] : s.x;
                a && (o = C(o, N(m - u)));
                u = m
            }
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                m = this.pointAttr[""],
                n, u, o, s = this.markerGroup,
                q = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = V(g.plotX), e = g.plotY, k = g.graphic, n = g.marker || {}, u = !!g.marker, a = q && n.enabled === y || n.enabled, o =
                        g.isInside, a && e !== y && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[o ? "show" : "hide"](!0).animate(x({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
                            ...
                            if (o && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, u ? n : l).attr(a).add(s)
        ...
        getAttribs: function() {
            ...
            var r = a.zones,
                s = a.zoneAxis || "y",
                v;
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) : (e.color = e.color || oa(e.color || g).brighten(e.brightness).get(), e.negativeColor =
                e.negativeColor || oa(e.negativeColor || h).brighten(e.brightness).get());
        ...
        applyZones: function() {
            ...
            if (d.length && (i || j)) i && i.hide(), j && j.hide(), m = l.getExtremes(), o(d, function(d, o) {
                ...
                e = C(v(p(f, e), 0), k);
                f = C(v(s(l.toPixels(p(d.value, m.max), !0)), 0), k);
    ...
    R.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (q = 0; q < d; q++) {
                ...
                r = (o = k && w < (g ? 0 : f)) ? j : i;
                m[r] || (m[r] = {});
                if (!m[r][t]) n[r] && n[r][t] ? (m[r][t] = n[r][t], m[r][t].total = null) : m[r][t] = new Hb(l, l.options.stackLabels, o, t, h);
                r = m[r][t];
                r.points[s] = [p(r.cum, g)];
                e === "percent" ? (o = o ? i : j, k && m[o] && m[o][t] ? (o = m[o][t], r.total = o.total = v(o.total, r.total) + N(w) || 0) : r.total = ea(r.total + (N(w) || 0))) : r.total = ea(r.total + (w || 0));
                r.cum = p(r.cum,
                    g) + (w || 0);
                r.points[s].push(r.cum);
                c[q] = r.cum
            }
        ...
        update: function(a, b, c, d) {
            function e() {
                ...
                if (da(a) && !Ha(a)) f.redraw = function() {
                    if (h)
                        if (a && a.marker && a.marker.symbol) f.graphic = h.destroy();
                        else h.attr(f.pointAttr[f.state || ""])[f.visible ? "show" : "hide"](!0);
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function() {
            ...
            var c = C(N(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                j = c * b.groupPadding,
                k = (c - 2 * j) / i,
                l = b.pointWidth,
                b = q(l) ? (k - l) / 2 : k * b.pointPadding,
                l = p(l, k - 2 * b);
        ...
        translate: function() {
            ...
            o(a.points, function(c) {
                var d = p(c.yBottom, f),
                    h = 999 + N(d),
                    h = C(v(-h, c.plotY), e.len + h),
                    o = c.plotX + k,
                    q = j,
                    t = C(h, d),
                    w, x;
                w = v(h, d) - t;
                N(w) < g && g && (w = g, x = !e.reversed && !c.negative || e.reversed && c.negative, t = s(N(t - f) > g ? d - g : f - (x ? g : 0)));
                c.barX = o;
                c.pointWidth = i;
                q = s(o + q) + l;
                o = s(o) + l;
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== y && !isNaN(i) && h.y !==
                    null) f = h.shapeArgs, i = q(a.borderWidth) ? {
                    "stroke-width": a.borderWidth
                } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](A(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
        ...
        animate: function(a) {
            var b = this.yAxis,
                ...
                e = {};
            if (ca) a ? (e.scaleY = 0.001, a = C(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len :
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({
            ...
            if (n && !h) e.dataLabel = n.destroy();
                ...
                if (n)
                    ...
                    if (t.color === "contrast") w.color = d.inside || d.distance < 0 || b.stacking ?
                        k.getContrast(e.color || a.color) : "#000000";
                    if (c) w.cursor = c;
                    for (r in n) n[r] === y && delete n[r];
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        var f = this.chart,
            ...
            l = this.visible && (a.series.forceDL || f.isInsidePlot(h, s(i), g) || d && f.isInsidePlot(h, g ? d.x +
                1 : d.y + d.height - 1, g));
        if (l) d = x({
            x: g ? f.plotWidth - i : h,
    ...
    if (M.pie) M.pie.prototype.drawDataLabels =
        function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (E = 2; E--;) {
                    ...
                    if (K) {
                        ...
                        if (m > 0) {
                            t = C(r + q + m, d.plotHeight);
                            for (G = v(0, r - q - m); G <= t; G += b) I.push(G);
                            t = I.length;
                            if (K > t) {
                                c = [].concat(H);
                                c.sort(L);
                            ...
                            for (G = 0; G < K; G++) {
                                ...
                                c = 9999;
                                var P, O;
                                for (O = 0; O < t; O++) P = N(I[O] - w[1]), P < c && (c = P, J = O);
                                if (J < G && I[G] !== null) J = G;
                                else
                                    for (t < K - G + J && I[G] !== null && (J = t - K + G); I[J] === null;) J++;
                                M.push({
                                    i: J,
                                    y: I[J]
                                });
                        ...
                        for (G =
                            ...
                            c = w[1];
                            if (m > 0) {
                                if (t = M.pop(), J = t.i, z = t.y, c > z && I[J + 1] !== null || c < z && I[J - 1] !== null) z = C(v(0, c), d.plotHeight)
                            } else z = c;
                            B = e.justify ? n[0] + (E ? -1 : 1) * (q + m) : a.getX(z === r - q - m || z === r + q + m ? c : z, E);
                            y._attr = {
                                visibility: F,
                                align: w[6]
                            };
                            ...
                            y.connX = B;
                            y.connY = z;
                            if (this.options.size === null) t = y.width, B - t < f ? D[3] = v(s(t - B + f), D[3]) : B + t > h - f && (D[1] = v(s(B + t - h + f), D[1])), z - b / 2 < 0 ? D[0] = v(s(-z + b / 2), D[0]) :
                                z + b / 2 > i && (D[2] = v(s(z + b / 2 - i), D[2]))
                        }
                    }
                }
                if (Fa(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(), x && g && o(this.points, function(b) {
                    j = b.connector;
                    w = b.labelPos;
                    if ((y = b.dataLabel) && y._pos && b.visible) F = y._attr.visibility, B = y.connX, z = y.connY, k = l ? ["M", B + (w[6] === "left" ? 5 : -5), z, "C", B, z, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", B + (w[6] === "left" ? 5 : -5), z, "L", w[2], w[3], "L", w[4], w[5]], j ? (j.animate({
                        d: k
            ...
            var b = this.center,
                ...
                f = e,
                g;
            d[0] !== null ? f = v(b[2] - v(a[1], a[3]), e) : (f = v(b[2] - a[1] - a[3],
                e), b[0] += (a[3] - a[1]) / 2);
            d[1] !== null ? f = v(C(f, b[2] - v(a[0], a[2])), e) : (f = v(C(f, b[2] - a[0] - a[2]), e), b[1] += (a[0] - a[2]) / 2);
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (d = 0; d < b; d++) {
                e = a[d];
                for (c = d + 1; c < b; ++c)
                    if (k = a[c], e && k && e.placed && k.placed && e.newOpacity !== 0 && k.newOpacity !== 0 && !(k.alignAttr.x > e.alignAttr.x + e.width || k.alignAttr.x + k.width < e.alignAttr.x || k.alignAttr.y > e.alignAttr.y + e.height || k.alignAttr.y + k.height < e.alignAttr.y))(e.labelrank < k.labelrank ? e : k).newOpacity = 0
            }
            for (d = 0; d < b; d++)
                if (c = a[d]) {
    ...
    U = z.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            for (m = 0; m < k.length; m++) e = k[m], d.push("M", e.plotX -
    ...
    if (M.column) xa.prototype.drawTracker = U.drawTrackerPoint;
        ...
        pan: function(a, b) {
            ...
            o(b === "xy" ? [1, 0] : [1], function(b) {
                var d = a[b ? "chartX" : "chartY"],
                    ...
                    i = i > d;
                if (h.series.length && (i || l > C(k.dataMin, k.min)) && (!i || j < v(k.dataMax,
                        k.max))) h.setExtremes(l, j, !1, !1, {
                    trigger: "pan"
                }), e = !0;
    ...
    x(Ga.prototype, {
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || o(e.getSelectedPoints(), function(a) {
                    if (a.selected && a !== c) a.selected = a.options.selected = !1, d.options.data[Ma(a, d.data)] =
        ...
        importEvents: function() {
            if (!this.hasImportedEvents) {
                var a =
                    A(this.series.options.point, this.options).events,
                    b;
                this.events = a;
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled ===
                    !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                ...
                if ((c = f[a] && f[a].halo) &&
                    ...
                    n.attr(x({
                        fill: oa(this.color || e.color).setOpacity(c.opacity).get()
